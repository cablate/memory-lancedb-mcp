...
*混合檢索（向量 + BM25）、Cross-Encoder 重排序、多 Scope 隔離、記憶生命週期管理*
...
停用：`"enableSelfImprovementTools": false`
...
```json
{
  ...
  "enableSelfImprovementTools": true,
  "scopes": {
    "default": "global",
    "definitions": {
...
| **Ollama**（本地） | `nomic-embed-text` | `http://localhost:11434/v1` | *視模型而定* |
